...
function createEmptyNote() {
    ...
    let noteText = "Edit note";
    let transformValue = "translate(15vw, 20vw)";
...
class NoteController {
    ...
    handleDrag(e) {
        ...
        let transformValue = `translate(${posX}px, ${posY}px)`;
        draggedElement.parentElement.style.transform = transformValue;
        this._noteModel.transformValue = transformValue;
    }
